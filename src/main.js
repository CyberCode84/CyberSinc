/**
 * CyberSinc - Vanilla JS Version (ES5 Compatible)
 * Optimized for low-end hardware (Old TV Boxes)
 */
...
// Templates (Using standard strings for better compatibility with really old WebViews)
var templates = {};

templates[STATE.LANDING] = 
...
templates[STATE.MIRRORING] = 
    '<div class="mirror-container">' +
        ...
        '<div class="overlay-ui">' +
            ...
            '</div>' +
        '</div>' +
        '<div style="position: absolute; bottom: 0; width: 100%; background: linear-gradient(rgba(0,0,0,0), rgba(0,0,0,0.8)); padding: 1.5rem; display: flex; justify-content: space-between; align-items: center;">' +
...
function startStats() {
    ...
    statsInterval = setInterval(function() {
        ...
        var latencyCounter = document.getElementById('latency-counter');
        
        if (fpsCounter) fpsCounter.textContent = fps + ' FPS';
        if (latencyCounter) latencyCounter.textContent = latency + 'ms DELAY';
    }, 2000);
}
